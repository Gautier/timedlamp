...
public class TimedLightWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager,
        ...
        for (int i=0; i<N; i++) {
            ...
            Intent intent_30 = new Intent(context, TimedLight.class);
            ...
            RemoteViews views = new RemoteViews(context.getPackageName(),
                                             R.layout.timedlight_widget_layout);
            views.setOnClickPendingIntent(R.id.button_30, pendingIntent_30);


            Intent intent_60 = new Intent(context, TimedLight.class);
            ...
            Intent intent_120 = new Intent(context, TimedLight.class);
